...
const getDifficultyColor = (difficulty) => {
  switch (difficulty) {
    case t.difficulty.simple:
      return 'bg-green-500'
    case t.difficulty.intermediate:
      return 'bg-yellow-500'
    case t.difficulty.advanced:
      return 'bg-orange-500'
    case t.difficulty.expert:
      return 'bg-red-500'
    default:
      return 'bg-gray-500'
  }
      ...
      <div class="flex items-center justify-between">
        <div class="flex gap-2">
          <router-link :to="project.demoUrl" :class="['flex gap-2 items-center',
            ...
            <span>{{ t.projects.cards.demo }}</span>
          </router-link>
          ...
          <a :href="project.githubUrl"
            ...
            <span>{{ t.projects.cards.code }}</span>
          </a>
        </div>
