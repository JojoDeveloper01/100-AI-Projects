...
const contactText = () => t.value?.contact?.form;
...
const validateForm = () => {
    ...
    if (name.length < 2 || name.length > 80) errors.name = text.errors.name;
    if (!emailPattern.test(email)) errors.email = text.errors.email;
    if (message.length < 10 || message.length > 2000) {
        errors.message = text.errors.message;
    }
...
const submitForm = async () => {
    ...
    try {
        ...
        if (!response.ok) {
            submitError.value = contactText().errors.submit;
            return;
        }
    ...
    <BaseLayout>
        <section class="relative py-10">
            <div class="mx-auto text-center">
                ...
                <p
                    class="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed"
                >
                    {{ t.contact.subtitle }}
                </p>
            </div>
        ...
        <div class="max-w-6xl mx-auto mb-16">
            <div
                v-if="showSuccess"
                class="mb-8 p-6 bg-green-500/20 border border-green-500/30 rounded-xl text-center"
            >
                <div
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                <div class="translation-card p-8">
                    ...
                    <form @submit.prevent="submitForm" class="space-y-6">
                        <div
                            v-if="submitError"
                            class="rounded-lg border border-red-500/30 bg-red-500/15 px-4 py-3 text-sm text-red-200"
                        >
                            {{ submitError }}
                        </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="translation-card p-8">
                        ...
                        <div class="flex space-x-4">
                            <a
                                href="https://github.com/JojoDeveloper01"
                                target="_blank"
                                rel="noopener"
                            ...
                            <a
                                href="https://www.linkedin.com/in/joseth-balcazar/"
                                target="_blank"
                                rel="noopener"
                                class="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors"
                            >
                            ...
                            <a
                                href="https://x.com/JojoDeveloper01"
                                target="_blank"
                                rel="noopener"
                                class="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors"
                            >
