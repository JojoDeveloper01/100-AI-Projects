    ...
    <nav class="z-20 py-4">
      <div class="mx-auto flex items-center justify-between">
        ...
        <div class="relative inline-block">
          <details class="group">
            <summary
              class="flex gap-2 items-center cursor-pointer px-4 py-2 rounded-md"
            >
              <svg
                aria-hidden="true"
                class="icon label-icon astro-5trz26bn astro-eytsx3ik"
                width="16"
                height="16"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <div
              class="absolute right-0 mt-2 w-36 bg-[#2a2a2a] rounded shadow-lg group-open:block z-999"
            >
              <ul>
                <li
