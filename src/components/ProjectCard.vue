...
<template>
  <div class="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
    <!-- Project Image -->
        ...
        <div class="flex items-center space-x-1">
          <div 
            ...
            :class="[
              ...
              n <= (['Beginner', 'Intermediate', 'Advanced', 'Expert'].indexOf(project.difficulty) + 1)
    ...
    <div class="p-6">
      ...
      <div class="flex items-center justify-between mb-3">
        <span class="text-purple-400 text-sm font-medium">{{ project.category }}</span>
      ...
      <div class="flex items-center justify-between">
        ...
        <!-- Completion Date -->
        <div v-if="project.completedDate" class="text-xs text-gray-500">
